/*
Deployment script for car_repair
...
GO
:setvar DatabaseName "car_repair"
:setvar DefaultFilePrefix "car_repair"
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER_14\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER_14\MSSQL\DATA\"
...
GO
PRINT N'Creating [dwh].[DimFranchise]...';
...
GO
PRINT N'Creating [dwh].[FactOrder]...';
...
GO
PRINT N'Creating [stg].[ServiceData_Cleaned]...';
...
GO
PRINT N'Creating [stg].[WBCallData_Cleaned]...';


GO
CREATE TABLE [stg].[WBCallData_Cleaned] (
    [WBCallDataDataKey] INT            IDENTITY (1, 1) NOT NULL,
    ...
    [SysDateCreated]    DATETIME       NULL,
    [SysSourceName]     NVARCHAR (255) NULL,
    CONSTRAINT [PK_stg_FactCallCleaned] PRIMARY KEY CLUSTERED ([WBCallDataDataKey] ASC)
);
...
GO
PRINT N'Creating [stg].[ServiceData]...';


GO
CREATE TABLE [stg].[ServiceData] (
    [UNServiceDataKey] INT            IDENTITY (1, 1) NOT NULL,
    [Region]           NVARCHAR (255) NULL,
    [SubRegion]        NVARCHAR (255) NULL,
    [Country]          NVARCHAR (255) NULL,
    [total2003]        NVARCHAR (255) NULL,
    ...
    [SysDateCreated]   DATETIME       NULL,
    [SysSourceName]    NVARCHAR (255) NULL,
    CONSTRAINT [PK_stg_ServiceData] PRIMARY KEY CLUSTERED ([UNServiceDataKey] ASC)
);


GO
PRINT N'Creating [stg].[WBCallData]...';


GO
CREATE TABLE [stg].[WBCallData] (
    [WBCallDataKey]  INT            IDENTITY (1, 1) NOT NULL,
    [CountryName]    NVARCHAR (255) NULL,
    [CountryCode]    NVARCHAR (255) NULL,
    [IndicatorName]  NVARCHAR (255) NULL,
    [IndicatorCode]  NVARCHAR (255) NULL,
    ...
    [SysDateCreated] DATETIME       NULL,
    [SysSourceName]  NVARCHAR (255) NULL,
    CONSTRAINT [PK_stg_WBCallData] PRIMARY KEY CLUSTERED ([WBCallDataKey] ASC)
);


GO
PRINT N'Creating [dwh].[DF_DWH_DimFranchise_CreateDate]...';


GO
ALTER TABLE [dwh].[DimFranchise]
    ADD CONSTRAINT [DF_DWH_DimFranchise_CreateDate] DEFAULT (getdate()) FOR [SysDateCreated];


GO
PRINT N'Creating [dwh].[DF_DWH_DimFranchise_ModifiedDate]...';


GO
ALTER TABLE [dwh].[DimFranchise]
    ADD CONSTRAINT [DF_DWH_DimFranchise_ModifiedDate] DEFAULT (getdate()) FOR [SysDateChanged];
...
GO
ALTER TABLE [stg].[ServiceData_Cleaned]
...
GO
ALTER TABLE [stg].[WBCallData_Cleaned]
